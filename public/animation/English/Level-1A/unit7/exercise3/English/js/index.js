const questions = [
  {
    ...
    sound1: "./English/sound/guava.wav",
    sound2: "./English/sound/papaya.wav",
    ans: "1",
  },
  {
    question: "2-7",
    ...
    sound1: "./English/sound/durian.wav",
    sound2: "./English/sound/starfruit.wav",
    ans: "2",
  },
  {
    question: "3-7",
    ...
    sound1: "./English/sound/honeydew.wav",
    sound2: "./English/sound/pineapple.wav",
    ans: "1",
  },
  {
    question: "4-7",
    ...
    sound1: "./English/sound/kiwi.wav",
    sound2: "./English/sound/orange.wav",
    ans: "1",
  },
  {
    question: "5-7",
    ...
    sound1: "./English/sound/mangosteen.wav",
    sound2: "./English/sound/strawberry.wav",
    ans: "2",
  },
  {
    question: "6-7",
    ...
    sound1: "./English/sound/lemon.wav",
    sound2: "./English/sound/lychee.wav",
    ans: "2",
  },
  {
    question: "7-7",
    ...
    sound1: "./English/sound/pomelo.wav",
    sound2: "./English/sound/watermelon.wav",
    ans: "1",
  },
];
...
function playWord(audio_id) {
  ...
  if (audio_id === "question_sound") {
    var word_sound = "./English/sound/" + questions[iQuestion].word + ".wav";
