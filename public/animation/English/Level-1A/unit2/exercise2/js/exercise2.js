...
function playCorrect() {
  ...
  document.getElementById("exercise").innerHTML +=
    "<div class='container' id='yeah' style='position: absolute; top: 15px; left: 20px; margin: 0px 50px 0px 50px; z-index: 4;'><img src='./img/yeah3.gif' style='width:100%'/></div>";
...
function checkAnswer(e) {
  ...
  if (user_ans === answer) {
    ...
    document.getElementById("exercise2__ans__img").innerHTML =
      "<img src='./img/tick.png' style='position:relative; z-index:8; height: 50px; margin: 15px' id='tick'/>";
    setTimeout(playCorrect, 700);
    audioElement.setAttribute("src", "../../../public/sound/magic.wav");
    audioElement.play();
  } else {
    document.getElementById("exercise2__ans__img").innerHTML =
      "<img src='./img/wrong.png' style='position:relative;  z-index:8; height: 50px; margin: 15px;' id='wrong''/>";
