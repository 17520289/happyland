const questions = [
  {
    ...
    choose1: "白色",
    choose2: "靛色",
    sound1: "./sound/white.wav",
    sound2: "./sound/indigo.wav",
    ans: "2",
  },
  {
    question: "2-6  ",
    ...
    choose1: "黑色",
    choose2: "粉红色",
    sound1: "./sound/black.wav",
    sound2: "./sound/pink.wav",
    ans: "1",
  },
  {
    question: "3-6  ",
    ...
    choose1: "灰色",
    choose2: "白色",
    sound1: "./sound/grey.wav",
    sound2: "./sound/white.wav",
    ans: "2",
  },
  {
    question: "4-6 ",
    ...
    choose1: "褐色",
    choose2: "黑色",
    sound1: "./sound/brown.wav",
    sound2: "./sound/black.wav",
    ans: "1",
  },
  {
    question: "5-6 ",
...
function playCorrect() {
  ...
  audioElement.play();
  $("#exercise").append(
    "<div class='container' id='yeah1' style='position: absolute; bottom: 100px; left: 20px; margin: 0px 50px 0px 50px; z-index:1;'><img src='../img/yeah3.gif' style='height: 600px'/></div>"
  );
