...
function playWrong() {
  ...
  audioElement.setAttribute("src", "./sound/ex2/wrong.wav");
  audioElement.play();
}
function playCorrect() {
  var audioElement = document.createElement("audio");
  audioElement.setAttribute("src", "./sound/ex2/correct.wav");
  audioElement.play();
...
function checkAnswer(clicked_id) {
  ...
  if (user_ans === questions[iQuestion].ans) {
    ...
    document.getElementById(clicked_id + "_img").innerHTML =
      "<img src='./img/tick.png' style='height: 80px; margin-left: -50px; id='tick'/>";
    ...
    document.getElementById(clicked_id + "_img").hidden = false;
    document.getElementById(clicked_id + "_img").innerHTML =
      "<img src='./img/wrong.png' style='height: 80px; margin-left: -50px; id='wrong''/>";
